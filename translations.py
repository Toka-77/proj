...
TRANSLATIONS = {
    ...
    "Qty":                 "الكمية",
    # Unit Cost و Selling Price معرفين فوق في قسم Inventory
    ...
    # ── Missing labels found in scan ────────────────────────────────────────
    "Live Room Status":       "الحالة المباشرة للغرف",
    "🏠  Live Room Status":   "🏠  الحالة المباشرة للغرف",
    "Revenue per Room Type (Segment Reporting)": "الإيرادات حسب نوع الغرفة",
    "📊  Revenue per Room Type (Segment Reporting)": "📊  الإيرادات حسب نوع الغرفة",
    "Revenue per Room":       "الإيرادات حسب الغرفة",
    "📊  Revenue per Room":   "📊  الإيرادات حسب الغرفة",
    "Enter customer name…":   "أدخل اسم العميل...",
    ...
    "➕  Add Purchase Invoice": "➕  إضافة فاتورة شراء",
    "Entry Detail Lines (select entry above)": "تفاصيل القيد (اختر قيداً أعلاه)",
    "📒  Entry Detail Lines (select entry above)": "📒  تفاصيل القيد (اختر قيداً أعلاه)",
    ...
    "Current Year Net Income": "صافي دخل السنة الحالية",
    "Cash & Cash Equivalents": "النقدية وما يعادلها",
    "System Expenses (Rent/Utils)": "مصروفات النظام (إيجار/مرافق)",
    "Total Revenue:":         "إجمالي الإيرادات:",
    "Total Expenses:":        "إجمالي المصروفات:",
    "Total Assets:":          "إجمالي الأصول:",
    "Total Liabilities:":     "إجمالي الالتزامات:",
